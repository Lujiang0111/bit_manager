...
BITMGR_API std::shared_ptr<IBitReader> CreateBitReader(const uint8_t *data, ByteOrders byte_order = ByteOrders::kBe);

BITMGR_API std::shared_ptr<IBitWriter> CreateBitWriter(ByteOrders byte_order = ByteOrders::kBe);

BITMGR_API std::shared_ptr<IBitWriter> CreateBitWriterWithBuffer(uint8_t *buf, ByteOrders byte_order = ByteOrders::kBe);
